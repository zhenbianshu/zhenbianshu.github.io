...
这个问题在我之前的文章 [从应用到内核查接口超时（上）]({{ site.baseurl }}/2018/09/app_to_kernel_solve_api_timeout_1.html) 中有提到，1.8 之后 JVM 对锁进行了优化，添加了偏向锁的概念，避免了很多不必要的加锁操作，但偏向锁一旦遇到锁竞争，取消锁需要进入 `safe point`，导致 STW。
